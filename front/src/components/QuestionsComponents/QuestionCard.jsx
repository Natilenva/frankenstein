    ...
    return (
        <article className="flex "> {/* p-4 gap-4  */}
            ...
            <Link to={`/question/${question.question_id}`} >
                <div>
                    <p className="text-xs font-normal mt-1 text-neutral-500">Tecnologia: { question.technology}</p>
                    <h1 className=" text-base mt-1 font-medium leading-tight text-white"> {question.question_title}{/* ❓ */}</h1>             
                    <p className="text-sm font-light mt-2 text-neutral-200">
                        {truncateTextCaracteres(question.question_description, 55)} {/* Limitar a 100 caracteres */}
